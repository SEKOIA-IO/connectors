...
# By default, the def '_load_data_sets' (line 320ish in this file) uses relative path
...
# so i propose the change on the relative path with the concat of the script dir path (go to line 329)
